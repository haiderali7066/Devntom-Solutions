...
const stats = [
  { value: 10, suffix: "+", label: "Years of Digital Excellence" },
  { value: 5, suffix: "%", label: "Top Global Engineering Talent" },
  { value: 120, suffix: "+", label: "Projects Delivered Worldwide" },
  { value: 50, suffix: "+", label: "Clients Across Industries" },
  { value: 100, suffix: "K+", label: "Development & Consulting Hours" },
];
  ...
  return (
    <section ref={sectionRef} className="relative bg-sky-500 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-28">
        {/* Heading */}
        <h2 className="text-white text-center text-3xl sm:text-4xl md:text-5xl font-light leading-tight max-w-4xl mx-auto">
          From Startups to Enterprises, Delivering High-Impact Digital Solutions
          
        </h2>

        {/* Stats Grid */}
        <div className="mt-14 md:mt-20 grid grid-cols-2 md:grid-cols-5 gap-5 md:gap-6">
